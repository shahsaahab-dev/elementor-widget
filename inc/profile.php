...
class Profile_Layout{
    ...
    // Custom User Profile for Users
    public function profile_layout_func(){
                      ...
                      <div class="row">
                        <div class="col-12 col-sm-auto mb-3">
                          <div class="mx-auto" style="width: 140px;">
                            <div class="d-flex justify-content-center align-items-center rounded" style="height: 140px; background-color: rgb(233, 236, 239); background-image:url('. get_user_meta($user_data->ID,"profile_picture",true) .')>
                        ...
                        <div class="col d-flex flex-column flex-sm-row justify-content-between mb-3">
                          ...
                          <div class="text-center text-sm-right">
                            ...
                            <div class="text-muted"><small>Joined '.$user_data->user_registered.'</small></div>
                          </div>
                        </div>
                      </div>
                                ...
                                <div class="row">
                                  <div class="col">
                                    <div class="form-group">
                                      ...
                                      <input class="form-control" type="text" name="name" placeholder="Enter Name Here" value="'.$user_data->display_name.'">
                                    </div>
                                  </div>
                                  <div class="col">
                                    <div class="form-group">
                                      <label>Username</label>
                                      <input class="form-control" type="text" name="username" placeholder="'.$user_data->user_login.'" disabled>
                                    </div>
                                  </div>
                                </div>
                                <div class="row">
              ...
              <div class="col-12 col-md-3 mb-3">
                <div class="card mb-3">
                  <div class="card-body">
                    <div class="px-xl-3">
                      <form method="post">
                      <input type="submit" name="logout" class="btn btn-block btn-secondary" value="Logout">
